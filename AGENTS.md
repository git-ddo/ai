...
- AI는 P0/P1/P2 누적 Criteria·Loader, P0 System Prompt·Provider·정규화·Prompt Context,
  Repository 참조 Validator와 P0/P1/P2 내부 Evidence 모델까지 구현했다.
- AI의 혼합 깊이 Prompt, P1/P2 정규화, Service, 최종 Wire DTO와 실제 리포트 API는 후속
  구현 대상이다.
