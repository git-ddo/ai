첨부한 창의학기제 설계서의 MVP 범위와 역할 구분을 기준으로 작성했습니다. 

# RepoMentor AI

> GitHub 프로젝트를 취업 경쟁력으로 바꾸는 AI 포트폴리오 코칭 서비스

RepoMentor AI는 개발자 취업을 준비하는 사용자가 자신의 GitHub 프로젝트를 포트폴리오 관점에서 점검하고 정리할 수 있도록 돕는 웹 서비스입니다.
...
RepoMentor AI는 공개 GitHub repository에서 확인할 수 있는 정보와 사용자가 직접 입력한 프로젝트 역할을 함께 활용하여 다음 내용을 제공합니다.
...
RepoMentor AI는 GitHub 기록만으로 사용자의 실력이나 팀 프로젝트 기여도를 확정하지 않습니다.
