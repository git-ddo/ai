...
| AI 내부 파이프라인 | P0 내부 모델·정규화·Prompt Context·Repository 참조 Validator 구현 |
| AI P1/P2 | 내부 Evidence 모델 확장부터 구현 예정 |
...
AI의 다음 작업은 `P1/P2 내부 Evidence 도메인 모델 확장`이다. 이후 Criteria, System Prompt,
정규화, 깊이 Validator와 Repository·Portfolio Service를 순서대로 확장한다.
