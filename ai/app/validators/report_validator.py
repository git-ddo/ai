...
class PolicyViolationCode(StrEnum):
    ...
    UNKNOWN_CRITERION_CONTEXT = "UNKNOWN_CRITERION_CONTEXT"
    CRITERION_CONTEXT_EVIDENCE_MISMATCH = "CRITERION_CONTEXT_EVIDENCE_MISMATCH"
    CRITERION_CONTEXT_CLAIM_MISMATCH = "CRITERION_CONTEXT_CLAIM_MISMATCH"
    UNUSED_CRITERION_CONTEXT = "UNUSED_CRITERION_CONTEXT"
